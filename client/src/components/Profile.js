...
const Profile = ({user, updateData, toggle, logout}) => {
    ...
    const updateProfile = (e) => {
        ...
        if(password !== rpassword) {
            ...
            axios.post('/user/update_profile', {...user, password}, {headers: {token: window.localStorage.getItem('token')}})
            .then(res => {
        ...
        return(<Modal isOpen={true} toggle={toggle} size="lg">
            ...
            <ModalBody>
                <Form onSubmit={updateProfile}>
                   ...
                   <ModalFooter>
                    <Button color="danger" className='mx-auto d-md-none' onClick={() => {toggle(); logout();}}>Log out</Button>
                    <Button type="submit" className='float-right' color="primary">Submit</Button>
                    <Button color="secondary" className='float-right' onClick={toggle}>Cancel</Button>
                   </ModalFooter>
                </Form>
            </ModalBody>
        </Modal>);
