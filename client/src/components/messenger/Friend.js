...
const Friend = ({conversation: {friend, conversation}, set_conversation, confirm_request}) => {
    return(
        <li className={ (conversation.unseen && (conversation.unseen !== friend._id) ? "unseen" : '') + " friend clearfix"} onClick={() => set_conversation(conversation._id)}>
